        ...
        while (currentDepth <= this.searchDepth) {
            ...
            for (final MoveScoreRecord record : records) {
                ...
                if (moveTransition.getMoveStatus().isDone()) {
                    currentValue = board.currentPlayer().getAlliance().isWhite() ? min(moveTransition.getToBoard(), currentDepth - 1, highestSeenValue, lowestSeenValue) : max(moveTransition.getToBoard(), currentDepth - 1, highestSeenValue, lowestSeenValue);
            ...
            System.out.println("\t" + this + " bestMove = " +bestMove+ " Depth = " +currentDepth+ " took " +(subTime) + " ms, ordered moves : " +records);
            setChanged();
