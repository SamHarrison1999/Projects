...
class App:
    ...
    def start_draw(self):
        ...
        draw_text('PRESS SPACE TO STRART', self.screen, [
    ...
    def playing_draw(self):
        ...
        draw_text('CURRENT SCORE: {}'.format(self.player.current_score),
                  self.screen, [WIDTH // 2 - 100, 0], 18, WHITE, START_FONT)
        self.player.draw()
        for enemy in self.enemies:
            enemy.draw()
        pygame.display.update()
    ...
    def game_over_draw(self):
        ...
        draw_text("GAME OVER", self.screen, [WIDTH // 2, 100], 52, RED, "arial", centered=True)
